...
public class MahasiswaKelasPengawasAdapter extends  RecyclerView.Adapter<MahasiswaKelasPengawasAdapter.ListViewHolder> {
    private JSONArray datas;
    public OnItemClickListener listener;

    public MahasiswaKelasPengawasAdapter(JSONArray datas, OnItemClickListener listener) {
        this.datas = datas;
    ...
    public ListViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        View view = layoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_row_detailkelaspengawas, viewGroup, false);
        return new MahasiswaKelasPengawasAdapter.ListViewHolder(view);
    }
